...
(defrecord Nobel [prize]) ; meets a map contract, in other words
                                        ; can be treated like a map.
(deftype Pulitzer [prize])

(defprotocol Award ; sort of like an interface.
  (present [this recipient]))

(defrecord Oscar [category]
  Award ; should implement the Award protocol see interface above.
  (present [this recipient]
